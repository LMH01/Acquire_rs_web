...
fn rocket() -> _ {
    rocket::build()
        ...
        .mount("/", routes![events, lobby, lobby_join, game_page, create_game, create_game_without_ip, join_game, leave_game, join_game_without_ip, players_in_game, debug, debug_busy])
